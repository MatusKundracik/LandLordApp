...
public class ApartmentServiceImpl implements ApartmentService {
  ...
  public List<ApartmentResponseDto> getAllApartmentsByLandlord() {
      ...
      Landlord landlord = landlordRepository.findByUser(user).orElseThrow(() -> new RuntimeException("Landlord not found"));

      return apartmentRepository.getAllApartmentsByLandlord(landlord)
              .stream()
  ...
  public ApartmentResponseDto updateApartment(long id, ApartmentRequestDto apartmentRequestDto) {
      ...
      if (apartmentRequestDto.getCity() != null)
      ...
      if (apartmentRequestDto.getFloor() != null)
          apartment.setFloor(apartmentRequestDto.getFloor());
